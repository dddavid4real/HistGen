...
class ShowTellModel(CaptionModel):
    ...
    def _sample_beam(self, fc_feats, att_feats, att_masks=None, args={}):
        beam_size = args.get('beam_size', 10)
        batch_size = fc_feats.size(0)
        ...
        for k in range(batch_size):
            ...
            self.done_beams[k] = self.beam_search(state, logprobs, args=args)
